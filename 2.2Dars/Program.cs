    ...
    internal class Program
    {
        ...
        public static void DirectorMenu()
        {
            ...
            while (true)
            {
                ...
                var passOfDirect = Console.ReadLine();
                var ress = directorService.CheckDitrectorPassword(userName, passOfDirect);
                Console.Clear();
                if (ress is false)
                {
        ...
        public static void TeacherMenu()
        {
            ...
            while (true)
            {
                ...
                var userN = Console.ReadLine();
                Console.Write("Enter Your Password : ");
                var pass = Console.ReadLine();
                var res = teacherService.CheckLogin(userN, pass);
                if (res is false)
                {
        ...
        public static void StudentMenu()
        {
            ...
            while (true)
            {
                ...
                var resultCheck = studentService.CheckPassword(userN, passw);
